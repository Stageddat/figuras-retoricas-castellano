...
import figurasRetoricas from '../../db/figurasRetoricas.json';

type Pregunta = [string, string];
...
function EjemploQuiz() {
    ...
    useEffect(() => {
        const ejemplos = Object.entries(ejemplosJSON) as Pregunta[];
        const preguntasMezcladas = ejemplos.sort(() => Math.random() - 0.5);
    ...
    const generarOpciones = (respuestaCorrecta: string) => {
        const todasOpciones = Object.keys(figurasRetoricas);
    ...
    const manejarRespuesta = (tipoSeleccionado: string) => {
        const [pregunta, respuestaCorrecta] = preguntas[preguntaActual];
        ...
        setRespuestas(prev => [
            ...prev,
            {
                pregunta,
                respuestaCorrecta,
                respuestaUsuario: tipoSeleccionado
            }
        ]);

        if (tipoSeleccionado === respuestaCorrecta) {
                        ...
                        {respuestas.map((respuesta, index) => (
                            ...
                            >
                                <div
                                    ...
                                    dangerouslySetInnerHTML={{ __html: respuesta.pregunta }}
                                />
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-[#0a0a0a] border-2 border-[#272727] p-6 rounded-lg mb-8">
                    <div
                        ...
                        dangerouslySetInnerHTML={{ __html: preguntas[preguntaActual][0] }}
                    />
                </div>
